---
title: Bàsic
description: Visual Studio Code és un editor amb suport per a molts llenguatges de programació.
---

import {Aside, Keyboard, Page} from "@xtec/astro"
...
| | |
|-|-|
| <Keyboard id="Ctrl"/> + <Keyboard id="+"/> | Fa la lletra més gran |
| <Keyboard id="Ctrl"/> + <Keyboard id="-"/> | Fa la lletra més petita |
