...
Cal que en el vostre reposiori **`portafoli-dam`** (Assignement <a href="https://classroom.github.com/a/j7cZFHOP" target="about_blank">**`portafoli-dam`**</a>) creu una carpeta amb el nom **`0483-raids`** i que dins afegiu un fitxer README.md amb tot el que us demano.
