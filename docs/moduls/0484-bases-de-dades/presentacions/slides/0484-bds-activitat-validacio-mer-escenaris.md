...
### Consigna
A partir del <a href="../../../assets/img/agencia-viatges-mer.png" target="_about">MER inicial de l'Agència de viatges</a>, cal que per a cada escenari, indiqueu:
...
2) - **On** ho representaríeu (entitats/relacions).  
  ...
  ```
Només cal que indiqueu una,

* o enganxeu una captura, podeu fer la captura i fent <kbd>Ctrl </kbd> + <kbd>V</kbd>, ja enganxareu la imatge al formulari, 
...
```
 ...
 des del formulari HTML, **genereu el vostre JSON** i pugeu-lo al campus.

---

## Els 10 escenaris (1/10)

1. **Un tour amb diversos viatges**  
...
2) - **On** ho representaríeu (entitats/relacions).  
    En aquest apartat podeu pujar una captura del MER facilitat, o bé indicar-ho amb un text,
...
## Lliurament
- Completeu el <a href="../../../assets/forms/0484-bds-activitat-validacio-mer-formulari.html" target="_about">formulari HTML</a>
